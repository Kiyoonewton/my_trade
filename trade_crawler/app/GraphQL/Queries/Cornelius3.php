  ...
  public function __invoke($_, $args)
  {
    ...
    for ($j = $start; $j < $end; $j++) {
      ...
      for ($l = 1; $l < 561; $l++) {
        ...
        $total4 = $this->processMatches([$team], $this->getSeasonId($j + 4)->first(), [1, 30])->first();
        ...
        $count2 = $this->getCountOddAndMatchday($total3, $total4)[0];
        if ($count === 6) {
          ...
          Result::create(['num' => $j + 1, 'season_id' => $seasonId, 'team1' => $team1, 'team2' => $team2, 'team3' => $team3, 'type' => "same", 'matchday' => $matchday1, 'outcome1' => $count1 === 6 ? 'Loss' : 'Win', 'outcome2' => $count1 === 6  ? "" : ($count2 === 6 ? 'Loss' : 'Win'), 'odd' => $sameOdd1, 'result' => $result1]);
