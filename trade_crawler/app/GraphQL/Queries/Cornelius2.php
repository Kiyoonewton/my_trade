    ...
    for ($j = $start; $j < $end; $j++) {
      ...
      for ($l = 1; $l < 561; $l++) {
        ...
        if ($count === 6 && $count1 === 6) {
          ...
          Result::create(['num' => $j + 1, 'season_id' => $seasonId, 'team1' => $team1, 'team2' => $team2, 'team3' => $team3, 'type' => "same", 'matchday' => $matchday1, 'outcome' => $count1 === 6 ? 'Loss' : 'Win', 'odd' => $sameOdd1, 'result'=>$result1]);
